...
\
	...
	$(STR)ft_strsplit.c $(STR)ft_strstr.c $(STR)ft_strsub.c $(STR)ft_strtrim.c $(STR)ft_strftrim.c \
	$(STR)ft_bzero.c $(STR)ft_strfsub.c $(STR)ft_malloc_error.c $(STR)ft_strtok.c \
\
